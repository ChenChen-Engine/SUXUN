...
public class GroupMemberSqlManager extends AbstractSQLManager {
    ...
    public static String getRemarkWithGroupId(String groupId, String voipaccount) {
        String sql = "select remark from group_members  where group_id ='" + groupId + "' and voipaccount ='" + voipaccount + "'";
        String remark = "";
        Cursor cursor = null;
        try {
            cursor = getInstance().sqliteDB().rawQuery(sql, null);
    ...
    public static String getGroupIdByVoipAcount( String voipaccount) {
        String sql = "select voipaccount from group_members  where  voipaccount ='" + voipaccount + "'";
        String groupId = "";
        Cursor cursor = null;
        try {
            cursor = getInstance().sqliteDB().rawQuery(sql, null);
