...
//        if(SDKCoreHelper.getCManager()!=null){
//            SDKCoreHelper.getCManager().setConferenceListener(null);
//        }
    }
...
//        if(SDKCoreHelper.getCManager()!=null){
//            SDKCoreHelper.getCManager().setConferenceListener(this);
//        }
    }
    ...
    public boolean isSuccess(String txt){
        ...
        try {
            ...
            if(jsonObject.has("statusCode")){
                String r = jsonObject.getString("statusCode");
                result = "000000".equalsIgnoreCase(r);
            }
    ...
    public String getCode(String txt){
        ...
        try {
            JSONObject jsonObject =new JSONObject(txt);
            if(jsonObject.has("statusCode")){
                 r = jsonObject.getString("statusCode");
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
