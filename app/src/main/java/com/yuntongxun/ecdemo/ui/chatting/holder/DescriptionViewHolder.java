...
public class DescriptionViewHolder extends BaseHolder{
	...
	public BaseHolder initBaseHolder(View baseView , boolean receive) {
		...
		descTextView.setSmallEmojiShowSize(DensityUtils.dip2px( 20));
		descTextView.setBigEmojiShowSize(DensityUtils.dip2px(100));
		...
		if(receive) {
			...
			listView = (ListView) baseView.findViewById(R.id.lvCatalog);
			type = 7;
			return this;
		}
