...
//                dismissPostingDialog();
    ...
    private void setResult(final String text, final int t) {
        ...
        ECDevice.setPersonInfo(personInfo, new ECDevice.OnSetPersonInfoListener() {
            @Override
            public void onSetPersonInfoComplete(ECError e, final int version) {
                IMChattingHelper.getInstance().mServicePersonVersion = version;
//                dismissPostingDialog();
                if (SdkErrorCode.REQUEST_SUCCESS == e.errorCode) {
    ...
    private void setNickName(ClientUser clientUser, String text) {
        Net.resetNickName(clientUser.getUserId(), text, new BaseObserver<ResetNickNameBean>() {
            @Override
            ...
            @Override
            public void onNext(ResetNickNameBean value) {
            }
