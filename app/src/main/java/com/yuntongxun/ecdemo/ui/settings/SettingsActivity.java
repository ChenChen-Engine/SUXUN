...
public class SettingsActivity extends ECSuperActivity implements View.OnClickListener{
    ...
    private SettingItem mSettingxiaomi;
    private SettingItem mSettingqr;

    private SettingItem zhubo;
    private SettingItem qunzong;
        ...
        public void onClick(View v) {
            ...
            ECAlertDialog buildAlert = ECAlertDialog.buildAlert(SettingsActivity.this, R.string.settings_logout_warning_tip, null, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    mExitType = 0;
                    handleLogout(false);
                    SDKCoreHelper.getInstance().cacheMap.clear();
                }
    ...
    private void initView() {
       ...
       mSignureTv = (TextView) findViewById(R.id.contact_signure);
        ...
        mSettingqr = (SettingItem) findViewById(R.id.settings_qr);
        mSettingqr.setOnClickListener(this);
        ...
        mSettingxiaomi =(SettingItem)findViewById(R.id.settings_xiaomi);
        mSettingxiaomi.setOnClickListener(this);
...
//        mSettingAppkey.setDetailText(getConfig(ECPreferenceSettings.SETTINGS_APPKEY));
    ...
    private void initActivityState() {
        ...
        mUsername.setText(ECApplication.nick);
    ...
    public void onClick(View v){
        switch (v.getId()) {
            ...
            case R.id.settings_huawei:
                ...
                break;
            case R.id.settings_xiaomi:
                startActivity(new Intent(this , MainActivity.class));
                break;
            case R.id.settings_qr:
                startActivity(new Intent(this , CaptureActivity.class));
                break;
            case R.id.settings_tui:
            case R.id.settings_kan:
