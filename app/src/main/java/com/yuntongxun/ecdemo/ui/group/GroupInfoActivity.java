    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if ("add@yuntongxun.com".equals(item.getVoipAccount())) {
                ...
                intent.putExtra("GROUP_LEVEL", groupLevel);
                intent.putExtra("NO_SHOUXIN_NUM", true);
...
//            }
    ...
    private void getGroupLevel() {
        Net.getGroupLevel(mGroup.getGroupId(), new BaseObserver<GetGroupLevelBean>() {
            @Override
            ...
            public void onNext(GetGroupLevelBean value) {
                if (value != null && value.getData() != null) {
                    groupLevel = value.getData().getGroup_level();
                    switch (value.getData().getGroup_level()) {
                        case 1:
                            level.setRightContent("普通群");
                            gag.setVisibility(View.GONE);
                            break;
                        case 2:
                            level.setRightContent("高级群");
                            break;
                        case 3:
                            level.setRightContent("VIP群");
                            break;
                    }
                }
            }
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.info_count://群成员
                ...
                intentMembers.putExtra("NO_SHOUXIN_NUM",true);
                intentMembers.putExtra("groupID",mGroup.getGroupId());
